$(function () {
  let theUrll = window.location.href.split('/')
  let theCurrentPage = theUrll[theUrll.length - 1]
  console.log(theCurrentPage)

  $(`.nav a[href=${theCurrentPage}]`).parent().addClass('active')
})
...
$('#sidebar').html(`
  ...
  <li class="nav-item menu-items">
    <a class="nav-link" href="documentRepo.html">
      ...
      <span class="menu-title">Document Repo</span>
    </a>
  </li>
  <li class="nav-item menu-items">
    <a class="nav-link" href="systemSearch.html">
      ...
      <span class="menu-title">System Search</span>
    </a>
  </li>
  <li class="nav-item menu-items">
  ...
  <li class="nav-item menu-items">
    <a class="nav-link" href="systemAudit.html">
      ...
      <span class="menu-title">System Audit</span>
    </a>
  </li>
  <li class="nav-item menu-items">
...
<ul class="navbar-nav navbar-nav-right">
  <li class="nav-item dropdown d-none d-lg-block">
    <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown"
      aria-expanded="false" href="#">+ Add New Case</a>
